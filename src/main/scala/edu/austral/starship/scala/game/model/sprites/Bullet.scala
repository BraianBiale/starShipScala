...
case class Bullet(position: Vector2, speed: Vector2, starship: Starship, time: Long = 0, size: Int = 25) extends Sprite {

  override def accept(visitor: ImageVisitor): PImage = visitor.visitBullet(this)
